...
/**
 * ProductVariantSearch represents the model behind the search form of `frontend\modules\ecommerce\models\ProductVariant`.
 */
class ProductVariantSearch extends ProductVariant
{
    ...
    {
        return [
            [['id', 'product_id', 'old_price', 'price'], 'integer'],
            [['name'], 'safe'],
        ];
    }
